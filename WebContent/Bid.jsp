...
<div>
	<h2>DETAILS</h2>
	<img src="${car.image}" alt="${car.make}" width="400" height="300">
		...
		<div class="container">
			<form action="Bid.jsp?carID=${car.carId}">
			<h2>Enter Bid</h2>
				<input type="text" name="bidOne">
				<button type="submit">Submit</button>
			


			<c:if test="${param.bidOne >= car.price*.9}">
				<c:out value="Accepted" />
				<c:out value="${param.bidOne}"/>
				
				${car.setPrice(bidPrice)}; <%-- // ${car.setPrice = bidOne} --%>
			...
			<%-- <a href="CartServlet?cartId=${car.carId}"><button type="submit"
					name="addcart" class="btn" value="">Buy</button></a> --%>
			</form>
